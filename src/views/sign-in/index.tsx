...
const SignIn = () => {
  ...
  return (
    <div className="flex w-full flex-col items-center justify-center gap-4 bg-white py-10">
      <p className="font-sora text-center text-xl font-bold">
        Start copying and pasting between browsers in seconds
      </p>
      <button
